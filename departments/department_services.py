...
async def create(
    ...
    result = await department_repo.create(
        name=name,
        db=db
    )
...
async def get_by_id(
    ...
    result = await department_repo.get_by_id(
...
async def patch(
    ...
    result = await department_repo.patch(
        department_id=department_id,
        data=data,
        db=db
    )
...
async def delete(
    ...
    result = await department_repo.delete(
        department_id=department_id,
        db=db
    )
